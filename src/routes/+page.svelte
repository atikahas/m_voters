...
<div class="mb-2 flex w-full flex-wrap gap-2 lg:flex-nowrap">
	<div class="flex flex-1">
		<select
			class="py-1 px-4 pe-9 block w-full border-neutral-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
